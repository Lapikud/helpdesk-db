...
public class CategoryAssetsServiceTest : IClassFixture<TestDatabaseFixture>
{
    private readonly TestDatabaseFixture _fixture;
    private readonly AppDbContext _context;
    private readonly CategoryAssetsService _service;
    ...
    public CategoryAssetsServiceTest(TestDatabaseFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task GetCategoryAssetsByAssetId_ShouldReturnCategoryAssetById()
    {
        ...
        // Act
        var categoryAssetFromRepository = await _service.GetCategoryAssetsByAssetId(
    ...
    public async Task CreateCategoryAssetWithSameAssetIdExists_ShouldReturnNull()
    {
        ...
        // Act
        var newCategoryAsset = await _service.CreateNewCategoryAsset(categoryAsset1.AssetId, categoryAsset1.CategoryId);
        Assert.Null(newCategoryAsset);
    }
    
    private (AppDbContext, CategoryAssetsService) SetupDependencies()
    {
